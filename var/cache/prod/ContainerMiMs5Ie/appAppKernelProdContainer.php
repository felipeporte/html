...
class appAppKernelProdContainer extends Container
{
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('eT9eH5zAaR2tcpsSkJ8nSdovwPmtgPjMdLaDLsAd2zu0jB4cEpQdxXozvDgQMsfZ'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                50 => 'ps_crossselling',
                51 => 'statscheckup',
                52 => 'statsregistrations',
                53 => 'statsbestproducts',
                54 => 'ps_facetedsearch',
                55 => 'revsliderprestashop',
                56 => 'iqitadditionaltabs',
                57 => 'iqithtmlandbanners',
                58 => 'iqitcompare',
                59 => 'iqitcontactpage',
                60 => 'iqitcookielaw',
                61 => 'iqitcrossselling',
                62 => 'iqitcountdown',
                63 => 'iqitelementor',
                64 => 'iqitemailsubscriptionconf',
                65 => 'iqitfreedeliverycount',
                66 => 'iqitlinksmanager',
                67 => 'iqitmegamenu',
                68 => 'iqitpopup',
                69 => 'iqitproductsnav',
                ...
                74 => 'iqitthemeeditor',
                75 => 'iqitwishlist',
                76 => 'iqitextendedproduct',
                77 => 'ph_simpleblog',
                78 => 'ph_blog_column_custom',
                79 => 'ph_relatedposts',
                80 => 'iqitdashboardnews',
                81 => 'iqitsociallogin',
            ],
            ...
            'secret' => 'eT9eH5zAaR2tcpsSkJ8nSdovwPmtgPjMdLaDLsAd2zu0jB4cEpQdxXozvDgQMsfZ',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-01-09',
            'locale' => 'es-ES',
            'use_debug_toolbar' => true,
            'cookie_key' => 'F9peDc25h9diewDEO94ItyUasxEyQA88DZQiThDGN3PAECWPbojkAV6vBi6Nahc1',
            'cookie_iv' => 'aVHPp0AXIPpu2FgB1YxcyQajuAwkx73U',
            'new_cookie_key' => 'def000007c8887ce1f156904f1b9a75ee3f6a1a87d105d38bf11ddc7a24a86bc03af962ace22d4425574bd001468f7b9d3fa148b40d3bcc4dcc5b7901704fad0414c9846',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAn/v+BmOjFgZU/nC7PqaE'."\n".'uJfaD17HU9JXWMpcMbTEAESf6fYcPxcO39Og0O2rtGB+XPC68VcU9z8gv9ZNRbHa'."\n".'/ctHbk6+5FPWUrFD/8XxTeB84o1qJYdd5qbPvy0xqmnfxNVHSMcgnOt5hawLSyPH'."\n".'F+JkNoDsEQ5BLMFTkYFpKuWKdZeT37y0RDM03W+ukhyAZ6S+Mo7MzSnVHNWPFDbZ'."\n".'92YDoCAbHBPxkZNVcKB4npQK4zeuiHl+ZDiLyczkyqIeBCPD4V5GViJOsHvmKqff'."\n".'BvQfXKVKOODxUKpz7ZTgOdKw8e0XqZWgwFqakJ5AjCOSW45eqZVvZP9yG+373cBn'."\n".'dQIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQCf+/4GY6MWBlT+'."\n".'cLs+poS4l9oPXsdT0ldYylwxtMQARJ/p9hw/Fw7f06DQ7au0YH5c8LrxVxT3PyC/'."\n".'1k1Fsdr9y0duTr7kU9ZSsUP/xfFN4HzijWolh13mps+/LTGqad/E1UdIxyCc63mF'."\n".'rAtLI8cX4mQ2gOwRDkEswVORgWkq5Yp1l5PfvLREMzTdb66SHIBnpL4yjszNKdUc'."\n".'1Y8UNtn3ZgOgIBscE/GRk1VwoHielArjN66IeX5kOIvJzOTKoh4EI8PhXkZWIk6w'."\n".'e+Yqp98G9B9cpUo44PFQqnPtlOA50rDx7ReplaDAWpqQnkCMI5Jbjl6plW9k/3Ib'."\n".'7fvdwGd1AgMBAAECggEAHNrSGPxpCnynYUHbX8QgXXvT8mA9ksZ2Bxduc++ex06Z'."\n".'ShUfyJhD0EZm86/eP3kE6YXorcUvTJ3H7hm8k6StswcyMbjFsMBXQFBlC5F7wXhL'."\n".'BgCMA8tLuiFdiGViFxKj76gpBH0Xyn2lDCE44ztHei0Utojfqv7XbfdLd4uv+HKn'."\n".'Vfk+CKQP/Pfs+MWR49izEtzv4U/PTsWRwYlUeWHCjAGI60hMNP8vi+1FDSHkBNCu'."\n".'2nsVrjCpHgzhsVWz5dRtL6N/66HSJ0lMRLAx/zVXCG/0jQT73wvejsjc/PIoz81G'."\n".'9yT/s3buxzygwUDmPs13XgbgkBk9pEg0TZhm2md7YQKBgQDcjJqlvHxE6hiVzHAl'."\n".'uG3i5HMdFB1YGfYYXD0DPz1khPQRHCtzr7u/C6hYHbjJD/aLHHhkaTfmvEIN4CFL'."\n".'WMF49zVjtWBgrndYEFTo1vGF7Y6+7wXCipHQQCO2UY5PtH/FHITDorxhYyLbhMUM'."\n".'TGujq22qBNvCptktG1N4//MB4QKBgQC5szMFMeVKfAFyDUnT9hFrbtifIF3aXtvR'."\n".'LFzsFdALmC6VIDNoVU70N30F1mP1xyM4o0+ii3NxH1XA7C3xBy82mZmAyn0hUzx0'."\n".'GwBSMIcD5aPAUYV/8AY6F5gIrIf0Awz1/ihIwTMnhq79FQGfdhHGnw5gNhSB8O9R'."\n".'CwFzm3lAFQKBgE3AQ8Sp7iVdYc1thRvHKPYUE4Ds1mt4u4la+ydp4/rL5D8j7y2Z'."\n".'hlaThYWK9NntBr2EC+1aKprtQ1wg55vobkx22huMla1/1BL3rvdmzz6nwOsO2Lj8'."\n".'oOsJsY1UsxbmSyTyKNvPQxoSGPfKlqz/Q/MvPDnz/IVizK1aNNMzaDgBAoGBAIQK'."\n".'r9SZzfhQhJacbEqTRX+mqdE8KoADwznQ2aHlQLF93GGdK/Cb+DAe5H8qGpnAp4K2'."\n".'XQGvNr7RESDEz0X7Xc7tGQFC+gagMPQ93tSSPO7ActdlIBAAk+zqqehBBcq0AJtJ'."\n".'xUs2VTFdyz+ZmDXStoEMyCQRUDO1JfXyZW3WtzihAoGAZtB9Fj3VqyxfSKCfT12/'."\n".'63YrCiBLaXdihMpW1gHwRr46VwInrkT1IRZP2XjP/f0Y0UXYIsThH2Rv4IZXtHyX'."\n".'INPGKaFODVambQ1OTnkbmd4T48qv2egrsRxzBrYSdSNXMknOgRARWDiCetkLKzSG'."\n".'kGN1hV8p29qk5NHXMwdrW+4='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                3 => (\dirname(__DIR__, 4).'/modules/ps_customersignin/translations'),
                4 => (\dirname(__DIR__, 4).'/modules/ps_shoppingcart/translations'),
                5 => (\dirname(__DIR__, 4).'/modules/ps_specials/translations'),
                6 => (\dirname(__DIR__, 4).'/modules/ps_newproducts/translations'),
                7 => (\dirname(__DIR__, 4).'/modules/ps_bestsellers/translations'),
                8 => (\dirname(__DIR__, 4).'/modules/ps_emailsubscription/translations'),
                9 => (\dirname(__DIR__, 4).'/modules/ps_customeraccountlinks/translations'),
                10 => (\dirname(__DIR__, 4).'/modules/productcomments/translations'),
                11 => (\dirname(__DIR__, 4).'/modules/ps_categorytree/translations'),
                12 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                13 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                14 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                15 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                17 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                ...
                45 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                ...
                49 => (\dirname(__DIR__, 4).'/modules/iqitadditionaltabs/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/iqithtmlandbanners/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/iqitcompare/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/iqitcontactpage/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/iqitcookielaw/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/iqitcrossselling/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/iqitcountdown/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/iqitelementor/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/iqitemailsubscriptionconf/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/iqitfreedeliverycount/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/iqitlinksmanager/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/iqitmegamenu/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/iqitpopup/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/iqitproductsnav/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/iqitproducttags/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/iqitreviews/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/iqitsearch/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/iqitsizecharts/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/iqitthemeeditor/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/iqitwishlist/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/iqitextendedproduct/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/ph_simpleblog/translations'),
                71 => (\dirname(__DIR__, 4).'/modules/ph_blog_column_custom/translations'),
                72 => (\dirname(__DIR__, 4).'/modules/ph_relatedposts/translations'),
                73 => (\dirname(__DIR__, 4).'/modules/iqitdashboardnews/translations'),
                74 => (\dirname(__DIR__, 4).'/modules/iqitsociallogin/translations'),
            ],
            ...
            'kernel.secret' => 'eT9eH5zAaR2tcpsSkJ8nSdovwPmtgPjMdLaDLsAd2zu0jB4cEpQdxXozvDgQMsfZ',

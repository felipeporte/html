...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  array (
    ...
    array (
      0 => 'module:iqitsizechartsviewstemplateshookiqitsizecharts.tpl',
      1 => 1704823163,
      2 => 'module',
    ),
  ),
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['i']->value => $_smarty_tpl->tpl_vars['chart']->value) {
...
?>
                        <li class="nav-item">
                            <a class="nav-link<?php if ((isset($_smarty_tpl->tpl_vars['__smarty_foreach_charts']->value['first']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_charts']->value['first'] : null)) {?> active<?php }?>" data-toggle="tab" href="#iqitcharts-tab-<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['i']->value, ENT_QUOTES, 'UTF-8');?>
">
                                <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['chart']->value['title'], ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->tpl_vars['__smarty_foreach_charts']->value['first'] = !$_smarty_tpl->tpl_vars['__smarty_foreach_charts']->value['index'];
?>
                    <div class="tab-pane in<?php if ((isset($_smarty_tpl->tpl_vars['__smarty_foreach_charts']->value['first']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_charts']->value['first'] : null)) {?> active<?php }?>" id="iqitcharts-tab-<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['i']->value, ENT_QUOTES, 'UTF-8');?>
">

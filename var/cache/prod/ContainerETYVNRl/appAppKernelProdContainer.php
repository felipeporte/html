    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                25 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                ...
                36 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
